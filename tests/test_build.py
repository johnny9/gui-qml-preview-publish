...
from preview_publish.build import _contains_display_version, configure_command
...
class BuildCommandTest(unittest.TestCase):
    def test_detects_utf16_qstring_literal_version(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            binary.write_bytes(b"prefix" + "d63e9642c2cf".encode("utf-16le") + b"suffix")

            self.assertTrue(_contains_display_version(binary, "d63e9642c2cf"))
    ...
    def test_configure_matches_pr_depends_build(self, _require_tool) -> None:
        ...
        self.assertIn("-DGUI_QML_BUILD_VERSION=d63e9642c2cf", command)
        self.assertTrue(
